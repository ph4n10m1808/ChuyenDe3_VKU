...
if (isset($_POST['submit'])) {
    ...
    if (move_uploaded_file($image['tmp_name'], $uploadFile)) {
        ...
        $sql = "INSERT INTO users (username, passwd, full_name, dob, address, phone, avatar) VALUES (?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param('sssssss', $username, $password, $full_name, $birthdate, $address, $phone, $uploadFile);
